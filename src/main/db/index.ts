...
const MIGRATIONS: string[] = [
  ...
  `,
  // kitchen print is now a timestamp, not a status; partial payments support
  `
  ...
  `,
  // v7 - manual service charge, any order type
  `
  ALTER TABLE orders ADD COLUMN service_charge INTEGER NOT NULL DEFAULT 0;
  `,
  // v8 - customer name on every order type (for the ledger)
  `
